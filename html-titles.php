...
class WP_HTML_Titles {
	...
	public static function admin_enqueue_scripts() {
		...
		if ( 'post' == $current_screen->base && post_type_supports( $current_screen->post_type, 'html_title' ) ) {
			wp_enqueue_script( 'wp-html-title', plugin_dir_url( __FILE__ ) . 'assets/html-title-editor.js', array(), '0.1' );
			wp_enqueue_style( 'wp-html-title', plugin_dir_url( __FILE__ ) . 'assets/html-title-editor.css', array(), '0.1', 'all' );
